    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                checkEmail = _a.sent();
                if (checkEmail) {
                    throw http_errors_1.default(422, { email: 'has already been taken' });
                }
                return [2 /*return*/];
        }
    });
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                if (!email) {
                    throw http_errors_1.default(422, { email: "can't be blank" });
                }
                if (!name) {
                    throw http_errors_1.default(422, { name: "can't be blank" });
                }
                if (!password) {
                    throw http_errors_1.default(422, { password: "can't be blank" });
                }
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                _c.label = 3;
            case 3: throw http_errors_1.default(403, {
